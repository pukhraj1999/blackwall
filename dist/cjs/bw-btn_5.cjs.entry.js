...
const BwBtn = class {
    ...
    render() {
        return (index.h("div", { key: 'fc94608cf1bc84fbdd589ed2d4960abec3f75200', class: "btn-box" }, index.h("a", { key: '65de8d58ba767d43d1038c9f109b00fcfde24ad1', href: this.link, class: "btn", onClick: this.performAction }, this.name)));
    }
};
...
const BwCard = class {
    ...
    render() {
        return (index.h("div", { key: '4854c18f4781401ea343f29fe2d4ccffd763bd46', class: "card" }, index.h("img", { key: '149c32b9d932262ecc51f9c160ad160172696f19', src: this.imgSrc || '', alt: this.imgAlt || '', class: "card-img" }), index.h("div", { key: 'b224d68fa9b0f69fdf0561a2dc667aa2047ec669', class: "card-content" }, index.h("p", { key: '202bd12d24ae6d6d6808d359133efc6f03692cf8', class: "card-title" }, this.name || ""), index.h("div", { key: '5952a03c00b13b8448c4b6a2ad0f9f882f138d55', class: "card-tags" }, index.h("span", { key: 'f78fb685c3e93cf09bd429cbd5ff535efcb98273', class: "card-tag-title" }, this.tagTitle || ''), this.tags && this.tags.map((tag, index$1) => (index.h("span", { class: "card-tag", style: { backgroundColor: this.getColorForTag(index$1) } }, tag)))), index.h("p", { key: '5a5f6deac711cb7e7e0d2e84e1bc63e9b0ffa4d6', class: "card-description" }, this.setDescription || ''), this.showBtn && index.h("bw-btn", { key: 'e0e81ba2c17a16593b3b5c5eed92d1d92b6e0b20', name: "Learn More", link: this.link || '#' }))));
    }
};
