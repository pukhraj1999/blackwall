...
const BwContainer = class {
    ...
    grid = false;
    render() {
        return (index.h("main", { key: '0075b6950189321fd911a03cec91a7c43ed30580', class: { "container": true, "primary": this.primary, "container-grid": this.grid }, style: { margin: this.mg, padding: this.pd } }, index.h("slot", { key: '936f3bae96215570b0f44285ad71543a88959f3d' })));
    }
};
