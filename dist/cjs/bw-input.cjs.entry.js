...
const BwInput = class {
    ...
    render() {
        return (index.h("div", { key: '0161e6dcfe6278f054a12beb69c515381f4f8d53', class: "input-box", style: {
                margin: this.boxMg,
            ...
            } }, index.h("p", { key: 'e51d73e07df1a61d3a22243b9e581b1e1adbc721', class: {
                'label-bold': this.labelBold,
            }, style: {
                fontSize: this.labelSize,
            } }, this.label), !this.textarea && (index.h("input", { key: 'ceb0bd0061459f065f4d4111e300012e87ef710e', style: {
                margin: this.mg,
                padding: this.pd,
                fontSize: this.size,
            }, class: {
            ...
            }, type: this.type, placeholder: this.placeholder, value: this.value, disabled: this.isDisabled, required: this.isRequired })), this.textarea && (index.h("textarea", { key: '08d540ff6319fd00923cebc79dbd0a2e6db19d27', style: {
                margin: this.mg,
                padding: this.pd,
                fontSize: this.size,
            }, class: {
                'input': true,
                'input-error': this.isError,
            }, rows: this.row, cols: this.col, placeholder: this.placeholder, value: this.value, disabled: this.isDisabled, required: this.isRequired })), this.isError && (index.h("p", { key: 'cbbe2285f1b2e42f4b165f5f3a8f2e30e87372d2', class: {
                'error-msg': true,
