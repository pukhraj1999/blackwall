...
const BwInput = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.changedValue = createEvent(this, "changedValue");
    }
    isError = false;
    value = '';
    isRequired = false;
