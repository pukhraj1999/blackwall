...
const BwCard = class {
    ...
    render() {
        return (index.h("div", { key: 'b7cd2d28eb41bc9cb8d0337a503a3491bfe3adfe', class: "card" }, index.h("img", { key: 'f4d7a796e19daf3b563fec6516bbe26ca1562bc6', src: this.imgSrc, alt: this.imgAlt, class: "card-img" }), index.h("div", { key: 'c416be572486fc37b7ecbf4ac1b9c4bcdbd089d9', class: "card-content" }, index.h("p", { key: 'a18ea00c82b304b64f9dcc4cfd3cc817b0cc52d3', class: "card-title" }, this.name), index.h("div", { key: 'e62c8b9f73bc549f8b8c4bac39b428c99d73c517', class: "card-tags" }, index.h("span", { key: '00ca676ce69b28d73c1beb0043ae97216f54718c', class: "card-tag-title" }, this.tagTitle), this.tags.map((tag, index$1) => (index.h("span", { class: "card-tag", style: { backgroundColor: this.getColorForTag(index$1) } }, tag)))), index.h("p", { key: '93e774445a0106e34018c13ff14ec38846d510f3', class: "card-description" }, this.description), index.h("div", { key: '93bd017c94e65d75495609e0770cc23e49c202a0', class: "card-btn-box" }, index.h("a", { key: '7b7a873aee2434f0b5147d557df22a3757a338b9', href: this.Link, class: "card-btn" }, "Learn More")))));
    }
};
...
const BwContainer = class {
    ...
    grid = false;
    render() {
        return (index.h("main", { key: 'b19ad5eda922a81c1ad9be94ae2f69c978e4a99a', class: { "container": true, "container-grid": this.grid }, style: { margin: this.mg, padding: this.pd } }, index.h("slot", { key: '9b2c309104c22181aabd035d8dc7899b448c2b01' })));
    }
};
...
const BwNav = class {
    ...
    render() {
        return (index.h("nav", { key: 'efba128fdc10a09173d12db27911fbba86325fa7', class: "nav-container", style: { margin: this.mg, padding: this.pd } }, index.h("div", { key: '377dd897009c05ed43d8e07787096473848466c1', class: "left" }, index.h("a", { key: '33bdf2b09497ffecdbb80050c52824c3da92f443', href: this.homeLink.link, class: "left-header" }, this.homeLink.name)), index.h("div", { key: '3894d5de28e5304c6cb87fabcc30b66e57b8b49e', class: "mid" }), index.h("div", { key: '6df53a2a2499dd7aed390555e7528d2f70f8b63a', class: "right" }, this.links.map(({ name, link }) => index.h("a", { class: "right-link", href: link }, name)))));
    }
};
