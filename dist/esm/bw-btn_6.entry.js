...
const BwNav = class {
    ...
    render() {
        return (h("section", { key: '1812ecf40897b716c676ed8d5602c21a27d31440' }, h("nav", { key: 'dd22e272fe0d8a4a088a9e75ebc2cc3fa55f4ab2', class: "nav-container", style: { margin: this.mg, padding: this.pd } }, h("div", { key: 'f1d9bfaa99706f6d57791e7735ca1631848f8851', class: "left" }, h("a", { key: '6332d3434ba22a038041abc74f91291f110936f0', href: this.homeLink.link, class: "left-header" }, this.homeLink.name)), h("div", { key: 'ff9d084127178afb375624cea145e6b74b7fd804', class: "mid" }), h("div", { key: 'bf9ea6b1f88e1ecf11a007ac8fafc9647358f378', class: "right" }, this.links.map(({ name, link }) => (h("a", { class: "right-link", href: link }, name)))), h("div", { key: '0e11c55f87aa20407584620e6c3a5f68654be851', class: "mobile-right" }, h("img", { key: '7f4f71b3d16c9f3001349c72ef254197e4c62d33', onClick: this.openModal, class: "burger-icon", src: barsSolidFullSvg, alt: "" }))), h("bw-modal", { key: 'bbf0c5ffe4fe9992803e7b5e8b5f2c5ca5e7ce16', isOpen: this.isModalOpen, onModalClosed: () => (this.isModalOpen = false) }, h("div", { key: '5f8f79a687abb8a92a43dffa19e083ad7a80877a', class: "mobile-link-box" }, this.links.map(({ name, link }) => (h("bw-btn", { name: name, link: link, onPress: () => this.isModalOpen = false })))))));
    }
};
